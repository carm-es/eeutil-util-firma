...
@XmlType(name = "CopiaInfo",
    propOrder = {"idAplicacion", "csv", "fecha", "expediente", "nif", "urlSede", "contenido",
        "tituloAplicacion", "tituloCSV", "tituloFecha", "tituloExpediente", "tituloNif",
        "tituloURL", "estamparLogo", "lateral", "urlQR", "opcionesPagina"})

public class CopiaInfo extends DataWsEntradaBase implements Serializable, IMDCAble {
  ...
  private String nif;
  @XmlElement(required = false, name = "urlSede",
      defaultValue = "https://sede.administracionespublicas.gob.es/valida")
