...
public class TextosProperties {
  ...
  protected final static Log logger = LogFactory.getLog(TextosProperties.class);

  private static TextosProperties instance = null;
  private static Properties propiedades = null;

  public static TextosProperties getInstance() throws EeutilException {
    if (instance == null) {
  ...
  private TextosProperties() throws EeutilException {
    try {
      ...
      throw new EeutilException(
          "Error al cargar las propiedades de application.properties" + e.getMessage(), e);
    }
  }
