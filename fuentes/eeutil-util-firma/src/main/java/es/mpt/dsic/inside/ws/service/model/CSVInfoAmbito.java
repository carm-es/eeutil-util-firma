...
public class CSVInfoAmbito extends DataWsEntradaBase implements Serializable, IMDCAble {
  ...
  public String toString() {
    return "CSVInfo [contenido=" + Arrays.toString(contenido) + ", mime=" + mime + ", ambito="
        + ambito + "]";
  }
