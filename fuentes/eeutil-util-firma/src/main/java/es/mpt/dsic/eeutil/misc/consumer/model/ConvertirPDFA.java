...
/**
 * <p>
 * Clase Java para convertirPDFA complex type.
 * 
 * <p>
 * El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="convertirPDFA">
 *   &lt;complexContent>
...
@XmlType(name = "convertirPDFA",
    propOrder = {"aplicacionInfo", "documentoEntrada", "nivelCompilacion"})
public class ConvertirPDFA {
  ...
  /**
   * Obtiene el valor de la propiedad documentoEntrada.
   * 
   * @return possible object is {@link DocumentoEntrada }
   * 
   */
  ...
  /**
   * Define el valor de la propiedad documentoEntrada.
   * 
   * @param value allowed object is {@link DocumentoEntrada }
   * 
   */
  ...
  /**
   * Obtiene el valor de la propiedad nivelCompilacion.
   * 
  ...
  /**
   * Define el valor de la propiedad nivelCompilacion.
   * 
