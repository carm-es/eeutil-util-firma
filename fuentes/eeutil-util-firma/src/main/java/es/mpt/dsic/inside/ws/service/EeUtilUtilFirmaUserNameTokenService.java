...
public interface EeUtilUtilFirmaUserNameTokenService {
	...
	public String generarCSVAmbito(
			@WebParam(name = "CSVInfoAmbito") @XmlElement(required = true, name = "CSVInfoAmbito") CSVInfoAmbito copia)
			throws InSideException;
	...
	public CopiaInfo generarInforme(
			@WebParam(name = "copiaInfoExtended") @XmlElement(required = true, name = "copiaInfoExtended") CopiaInfoExtended copia)
			throws InSideException;

	@WebMethod(operationName = "generarHash", action = "urn:generarHash")
	@WebResult(name = "hash", partName = "hash")
	public String generarHash(@XmlElement(required = true, name = "fichero") DataHandler fichero, @XmlElement(required = true, name = "algoritmo") String algoritmo)throws InSideException;
	
	@WebMethod(operationName = "validarHash", action = "urn:validarHash")
	@WebResult(name = "resultado", partName = "resultado")
	public boolean validarHash(@XmlElement(required = true, name = "fichero") DataHandler fichero, @XmlElement(required = true, name = "hashHEX") String hashHEX)throws InSideException;
