...
/**
 * <p>
 * Clase Java para visualizarFacturaeResponse complex type.
 * 
 * <p>
...
@XmlType(name = "visualizarFacturaeResponse", propOrder = {"facturaProcesada"})
public class VisualizarFacturaeResponse {
   ...
   * 
   * @return possible object is {@link SalidaVisualizacion }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link SalidaVisualizacion }
   * 
   */
