...
public class SignatureProcessor {
     ...
     */
    public void processSign(byte[] signature, byte[] signedDocument, String idAplicacion)   throws AOUnsupportedSignFormatException, AOException, Exception {
        ...
        if (signedDocument == null) {
        	...
        	if (signedDocument == null) {
        		InformacionFirmaAfirma infoAfirma = afirmaService
					.obtenerInformacionFirma(idAplicacion,
						signature, false,
						true,
						false, null);
