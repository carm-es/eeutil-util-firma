...
/**
 * <p>
 * Clase Java para convertirPDFAResponse complex type.
 * 
 * <p>
...
@XmlType(name = "convertirPDFAResponse", propOrder = {"pdfSalida"})
public class ConvertirPDFAResponse {
   ...
   * 
   * @return possible object is {@link PdfSalida }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link PdfSalida }
   * 
   */
