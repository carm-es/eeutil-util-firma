...
public class PdfCopiaNormalizadaUtils {
   ...
   */
  public File copiaAutenticaNormalizada(File ficheroPDF, CopiaInfo copia, String rutaLogo,
      boolean simple, ListaFirmaInfo listaFirma, int pagsBlanco)
      throws CopiaAutenticaCantBeGeneratedException, DocumentException, IOException {
    FileInputStream fis = null;
    FileOutputStream fos = null;
            ...
            if (listaFirma.getInformacionFirmas().size() <= NUM_FIRMANTES_ABAJO_MAX) {
              ...
              if (i >= primeraPaginaBlanco) {
                ...
                PdfPTable tablaFirmantes =
                    createWideTable(FILAS_SIMPLE, reader.getPageSize(i).getWidth());
                ...
                pintarTablaFirmantesEnHojaBlanca(tablaFirmantes, over,
                    reader.getPageSize(i).getWidth(), reader.getPageSize(i).getHeight());
              }
          ...
          if (listaFirma != null) {
            ...
            if (listaFirma.getInformacionFirmas().size() <= NUM_FIRMANTES_ABAJO_MAX) {
              ...
              if (i >= primeraPaginaBlanco) {
                ...
                PdfPTable tablaFirmantes =
                    createWideTable(columnas, reader.getPageSize(i).getWidth());
                tratarTablaFirmantes(listaFirma.getInformacionFirmas(), iInicial, iFinal, copia,
  ...
  private void pintarLogo(String rutaLogo, PdfContentByte pdfContentByte)
  ...
  private void tratarTablaFirmantes(List<FirmaInfo> listaFirmas, int iInicial, int iFinal,
      CopiaInfo copia, boolean simple, PdfPTable footer) throws DocumentException, IOException {
    TextosProperties tprop = TextosProperties.getInstance();
