...
public class ObjectFactory {
  ...
  private final static QName _ConvertirTCNAPdfResponse_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "convertirTCNAPdfResponse");
  private final static QName _VisualizarFacturaeResponse_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "visualizarFacturaeResponse");
  private final static QName _ConvertirTCNAPdf_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "convertirTCNAPdf");
  private final static QName _VisualizarFacturae_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "visualizarFacturae");
  private final static QName _ComprobarPDFAResponse_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "comprobarPDFAResponse");
  private final static QName _ComprobarPDFA_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "comprobarPDFA");
  private final static QName _PostProcesarFirma_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "postProcesarFirma");
  private final static QName _ConvertirPDFAResponse_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "convertirPDFAResponse");
  ...
  private final static QName _ConvertirPDFA_QNAME =
      new QName("http://service.ws.inside.dsic.mpt.es/", "convertirPDFA");
  ...
  @XmlElementDecl(namespace = "http://service.ws.inside.dsic.mpt.es/",
      name = "convertirTCNAPdfResponse")
  public JAXBElement<ConvertirTCNAPdfResponse> createConvertirTCNAPdfResponse(
      ConvertirTCNAPdfResponse value) {
    return new JAXBElement<ConvertirTCNAPdfResponse>(_ConvertirTCNAPdfResponse_QNAME,
        ConvertirTCNAPdfResponse.class, null, value);
  }
  ...
  public JAXBElement<VisualizarFacturaeResponse> createVisualizarFacturaeResponse(
    ...
    return new JAXBElement<VisualizarFacturaeResponse>(_VisualizarFacturaeResponse_QNAME,
        VisualizarFacturaeResponse.class, null, value);
  }
  ...
  public JAXBElement<ConvertirTCNAPdf> createConvertirTCNAPdf(ConvertirTCNAPdf value) {
    return new JAXBElement<ConvertirTCNAPdf>(_ConvertirTCNAPdf_QNAME, ConvertirTCNAPdf.class, null,
        value);
  }
  ...
  public JAXBElement<VisualizarFacturae> createVisualizarFacturae(VisualizarFacturae value) {
    return new JAXBElement<VisualizarFacturae>(_VisualizarFacturae_QNAME, VisualizarFacturae.class,
        null, value);
  }
   ...
   */
  @XmlElementDecl(namespace = "http://service.ws.inside.dsic.mpt.es/",
      name = "comprobarPDFAResponse")
  public JAXBElement<ComprobarPDFAResponse> createComprobarPDFAResponse(
      ComprobarPDFAResponse value) {
    return new JAXBElement<ComprobarPDFAResponse>(_ComprobarPDFAResponse_QNAME,
        ComprobarPDFAResponse.class, null, value);
  }
   ...
   */
  @XmlElementDecl(namespace = "http://service.ws.inside.dsic.mpt.es/",
      name = "convertirPDFAResponse")
  public JAXBElement<ConvertirPDFAResponse> createConvertirPDFAResponse(
      ConvertirPDFAResponse value) {
    return new JAXBElement<ConvertirPDFAResponse>(_ConvertirPDFAResponse_QNAME,
        ConvertirPDFAResponse.class, null, value);
  }
