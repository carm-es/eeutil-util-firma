...
public interface EeUtilService {
  ...
  public CopiaInfo generarCopia(
      ...
      @WebParam(name = "copiaInfo")
      @XmlElement(required = true, name = "copiaInfo") CopiaInfo copia,
      @WebParam(name = "simpleFormat")
      @XmlElement(required = true, name = "simpleFormat") boolean simple) throws InSideException;
  ...
  public CopiaInfo generarCopiaFirma(
      ...
      @WebParam(name = "copiaInfo")
      @XmlElement(required = true, name = "copiaInfo") CopiaInfo copia,
      @WebParam(name = "firmaInfo")
      @XmlElement(required = true, name = "firmaInfo") ListaFirmaInfo firmas,
      @WebParam(name = "simpleFormat")
      @XmlElement(required = true, name = "simpleFormat") boolean simple) throws InSideException;
  ...
  @WebResult(name = "CSVResult", partName = "CSVResult")
  public String generarCSVAmbito(
      @WebParam(name = "aplicacionInfo")
      @XmlElement(required = true, name = "aplicacionInfo") ApplicationLogin info,
      @WebParam(name = "CSVInfoAmbito")
      @XmlElement(required = true, name = "CSVInfoAmbito") CSVInfoAmbito copia)
      throws InSideException;

  /*
   * @WebMethod(operationName = "obtenerFirmantes", action = "urn:obtenerFirmantes")
   * 
   * @WebResult(name = "ListaFirmantes", partName = "ListaFirmantes") public ListaFirmaInfo
   * obtenerInformacionFirmas(@WebParam(name =
   * "aplicacionInfo") @XmlElement(required=true,name="aplicacionInfo")ApplicationLogin info,
   * 
   ...
   * 
   * @WebParam(name = "TipoFirma") @XmlElement(name="TipoFirma")String tipoFirma) throws
   * InSideException;
   */
  ...
  public CopiaInfoFirmaSalida generarJustificanteFirma(
      @WebParam(name = "aplicacionInfo")
      @XmlElement(required = true, name = "aplicacionInfo") ApplicationLogin info,
      @WebParam(name = "copiaInfoFirma")
      @XmlElement(required = true, name = "copiaInfoFirma") CopiaInfoFirma copiaInfoFirma,
      @WebParam(name = "simpleFormat")
      @XmlElement(required = true, name = "simpleFormat") boolean simple) throws InSideException;

  // @WebMethod(operationName = "generarCopiaFirmaCSV", action = "urn:generarCopiaFirmaCSV")
  // @WebResult(name = "infoFirma", partName = "infoFirma")
  // public CopiaInfoFirmaSalida generarCopiaFirmaCSV(@WebParam(name = "aplicacionInfo")
  // @XmlElement(required=true,name="aplicacionInfo")ApplicationLogin info,
  ...
  // @WebParam(name = "ObjectCopiaFirmaCSV") @XmlElement(required=true,name="ObjectCopiaFirmaCSV")
  // ObjectCopiaFirmaCSV objectCopiaFirmaCSV
  // ) throws InSideException;
  ...
  public CopiaInfo generarInforme(
      @WebParam(name = "aplicacionInfo")
      @XmlElement(required = true, name = "aplicacionInfo") ApplicationLogin login,
      @WebParam(name = "copiaInfoExtended")
      @XmlElement(required = true, name = "copiaInfoExtended") CopiaInfoExtended copia)
      throws InSideException;
