...
public interface EeUtilService {
  ...
  public String generarCSVAmbito(
      @WebParam(name = "aplicacionInfo") @XmlElement(required = true,
          name = "aplicacionInfo") ApplicationLogin info,
      @WebParam(name = "CSVInfoAmbito") @XmlElement(required = true,
          name = "CSVInfoAmbito") CSVInfoAmbito copia)
      throws InSideException;
  ...
  public CopiaInfo generarInforme(
      @WebParam(name = "aplicacionInfo") @XmlElement(required = true,
          name = "aplicacionInfo") ApplicationLogin login,
      @WebParam(name = "copiaInfoExtended") @XmlElement(required = true,
          name = "copiaInfoExtended") CopiaInfoExtended copia)
      throws InSideException;
